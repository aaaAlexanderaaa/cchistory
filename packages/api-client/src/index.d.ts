...
export declare class CCHistoryApiError extends Error {
...
export declare function createCCHistoryApiClient(options?: CCHistoryApiClientOptions): {
    getTurns(): Promise<UserTurnProjectionDto[]>;
    searchTurns(params: {
        q?: string;
        project_id?: string;
        source_ids?: string[];
    ...
    getTurn(turnId: string): Promise<UserTurnProjectionDto>;
    ...
    resetSourceConfig(sourceId: string, payload?: ResetSourceConfigRequest): Promise<SourceConfigMutationResponse>;
    getProjects(state?: "committed" | "candidate" | "all"): Promise<ProjectSummaryDto[]>;
    getProjectTurns(projectId: string, state?: "committed" | "candidate" | "all"): Promise<UserTurnProjectionDto[]>;
    getProjectRevisions(projectId: string): Promise<ProjectRevisionsResponse>;
    getLinkingReview(): Promise<LinkingReviewResponse>;
    getLinkingOverrides(): Promise<ProjectManualOverrideDto[]>;
    upsertLinkingOverride(payload: UpsertLinkingOverrideRequest): Promise<{
        override: ProjectManualOverrideDto;
        project?: ProjectSummaryDto;
    }>;
    getMasks(): Promise<MaskTemplateDto[]>;
    getDriftReport(): Promise<DriftReportDto>;
    getTurnLineage(turnId: string): Promise<PipelineLineageDto>;
    getArtifacts(projectId?: string): Promise<KnowledgeArtifactDto[]>;
    upsertArtifact(payload: UpsertArtifactRequest): Promise<ArtifactResponse>;
    getArtifactCoverage(artifactId: string): Promise<ArtifactCoverageRecordDto[]>;
    runCandidateGc(payload: {
        before_iso?: string;
        older_than_days?: number;
        mode?: "archive" | "purge";
    }): Promise<CandidateGcResponse>;
    getTombstone(logicalId: string): Promise<TombstoneProjectionDto>;
};
export {};
