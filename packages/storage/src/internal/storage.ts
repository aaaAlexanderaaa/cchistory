...
import { buildSessionRelatedWorkIndex as buildCanonicalSessionRelatedWorkIndex } from "@cchistory/canonical";
...
export class CCHistoryStorage {
  ...
  private buildSessionRelatedWorkIndex(): Map<string, SessionRelatedWorkProjection[]> {
    if (!this.cachedRelatedWorkBySessionId) {
      ...
      this.cachedRelatedWorkBySessionId = buildCanonicalSessionRelatedWorkIndex(sessions, fragments);
    }
