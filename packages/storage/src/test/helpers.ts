    ...
    sessions: [
      {
        ...
        source_session_id: `${platform}-source-session-${sessionId}`,
        resume_command: `cd ${workingDirectory} && ${platform === "claude_code" ? "claude --resume" : "codex resume"} ${platform}-source-session-${sessionId}`,
        resume_working_directory: workingDirectory,
        resume_command_confidence: 1,
        sync_axis: "current",
      },
    ],
    turns: [
      {
        ...
        path_text: [
          ...
          projectObservation?.workspacePath ?? workingDirectory,
          projectObservation?.repoRoot,
          projectObservation?.sourceNativeProjectRef,
